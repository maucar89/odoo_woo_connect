...
class gen_salereceipt(models.TransientModel):
    ...
    def find_payment_method(self,payment_type_id):
        if payment_type_id =='customer':
            payment_option_selection = self.env['account.payment.method'].search([('name','=','Manual'),('payment_type','=','inbound')])

        elif payment_type_id =='supplier':
         
            payment_option_selection = self.env['account.payment.method'].search([('name','=','Manual'),('payment_type','=','outbound')])
        else:
                pass

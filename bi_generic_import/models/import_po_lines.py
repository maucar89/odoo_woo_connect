...
class import_po_line_wizard(models.TransientModel):
	...
	purchase_order_file = fields.Binary(string="Select File")
        ...
        product_details_option = fields.Selection([('from_product', 'Take Details From The Product'), ('from_xls', 'Take Details From The XLS File')], default='from_xls', string="Product Details Option")

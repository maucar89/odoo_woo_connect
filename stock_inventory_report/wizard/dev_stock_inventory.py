...
class dev_stock_inventory(models.TransientModel):
    ...
    def export_stock_ledger(self):
        ...
        for warehouse_id in self.warehouse_ids:
            ...
            worksheet[work].write_merge(0, 1, 0, 9, 'REPORTE DE INVENTARIO', main_header_style)

            worksheet[work].write(4, 0, 'Compañia', header_style)
            worksheet[work].write(4, 1, 'Almacen', header_style)
            worksheet[work].write(4, 2, 'Locacion', header_style)
            worksheet[work].write(4, 3, 'Fecha Inicio', header_style)
            ...
            tags = ['Inicial', 'Compras', 'Ventas', 'Internos', 'Ajustes', 'Final']
            ...
            if not self.is_group_by_category:
                ...
                for line in lines:
                    ...
                    worksheet[work].write_merge(r, r, 0, 3, line.get('ref'), text_left)
                    c += 1
                    worksheet[work].write_merge(r, r, 0, 4, line.get('product'), text_left)
                    c=5
                ...
                for l_val in lines:
                    ...
                    for line in l_val.get('values'):
                        ...
                        worksheet[work].write_merge(r, r, 0, 3, line.get('ref'), text_left)
                        c += 1
                        worksheet[work].write_merge(r, r, 0, 5, line.get('product'), text_left)
                        c = 5
                        worksheet[work].write(r, c, line.get('beginning_qty'), text_right)
                        c += 1
                        worksheet[work].write(r, c, line.get('received_qty'), text_right)
